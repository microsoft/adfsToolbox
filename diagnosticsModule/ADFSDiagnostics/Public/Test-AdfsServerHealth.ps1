...
* Result : One value of 'Pass','Fail','NotRun','Error'
...
Function Test-AdfsServerHealth()
{
    ...
    switch (Get-ADFSRole)
    {
        "STS"
        {
            return TestAdfsSTSHealth -verifyO365 $verifyO365 -verifyTrustCerts $verifyTrustCerts;
        }
        "Proxy"
        {
            return TestAdfsProxyHealth -AdfsSslThumbprint $thumbPrint;
        }
        default
        {
